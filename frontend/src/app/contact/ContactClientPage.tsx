        ...
        <div className="max-w-6xl mx-auto px-5 sm:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              {/* Secure Contact */}
              <div className="p-5 rounded-xl glass border border-accent/20">
                <div className="flex items-center gap-3 mb-3">
                  <svg className="w-4 h-4 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/></svg>
                  <p className="text-sm font-semibold text-white">🔒 Secure Contact</p>
                </div>
                <p className="text-xs text-brand-400 leading-relaxed mb-3">
                  If you&apos;re reporting a security issue, privacy concern, fake profile, account vulnerability, or any sensitive information, you can contact me securely.
                </p>
                <div className="flex items-center gap-2 mb-3">
                  <svg className="w-3.5 h-3.5 text-accent shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                  <p className="text-sm text-accent font-medium">hiiinishant@gmail.com</p>
                </div>
                <a
                  href="/pgp/nishant-public-key.asc"
                  download="nishant-public-key.asc"
                  className="block text-center w-full py-2.5 px-4 rounded-lg bg-accent/10 hover:bg-accent/20 border border-accent/20 hover:border-accent/30 text-accent text-xs font-semibold uppercase tracking-wider transition-all duration-300 mb-3"
                >
                  Download PGP Public Key
                </a>
                <div className="mb-3 rounded-lg border border-white/10 bg-white/5 p-3">
                  <p className="text-[10px] font-semibold uppercase tracking-wider text-brand-400 mb-2">PGP Fingerprint</p>
                  <p className="font-mono text-xs leading-relaxed text-brand-200 whitespace-pre-line">
                    {pgpFingerprint}
                  </p>
                  <p className="mt-3 text-[11px] font-bold text-brand-200 leading-relaxed">
                ...
                <p className="text-[10px] text-brand-500 italic">
                  Encrypted emails are appreciated for sensitive communications.
                </p>
              </div>
            </div>
                ...
                {status === "success" ? (
                  ...
                  <>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5" id="contact-form">
                      ...
                      <div>
                        <label htmlFor="phone" className="block text-xs font-medium text-brand-300 mb-2 uppercase tracking-wider">Phone <span className="text-brand-500 normal-case">(optional)</span></label>
                        <input
                          type="tel"
                          id="phone"
                          name="phone"
